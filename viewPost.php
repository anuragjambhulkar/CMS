...
<body>
  ...
  <footer id="footer">
    ...
    <div id="slideContainer">
      <div id="slide1">
        ...
        <div id="socialBtnContainer">
          <a href="https://www.facebook.com/anurag.jambhulkar?mibextid=ZbWKwL"><i
              class="fa-brands fa-square-facebook"></i></a>
          <a href="https://www.instagram.com/anuragjambhulkar.dev.cp"><i class="fa-brands fa-instagram"></i></a>
          <a href="https://www.linkedin.com/in/anurag-jambhulkar-374122176.cp"><i class="fa-brands fa-linkedin"></i></a>
        </div>
    ...
    <div id="developed">developed by @AnuragJambhulkar</div>
  </footer>
</body>
